...
{
    class FireTripleRope : FirePattern
    {
        ...
        public FireTripleRope(ProjectileType projectileType) : base(projectileType)
        {
            delayTimer.Elapsed += OnTick;
        }
        public override void Fire(int x, int y)
        {
            List<Projectile> ppattern = new List<Projectile>(3);
            ppattern.Clear();
            ...
            //up and right rope
            ppattern.Add(CreateProjectile(cx + x, cy + y, new Vector2(v.X, -v.Y)));
            //up and left rope
            ppattern.Add(CreateProjectile(cx + x, cy + y, new Vector2(-v.X, -v.Y)));
            //at player rope
